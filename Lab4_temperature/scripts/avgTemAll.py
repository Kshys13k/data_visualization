...
plt.plot(x4_values, y4_values, color='red', linewidth=1, label="POL")
plt.plot(x_values, y_values, color='green', linewidth=1, label="BRA")
plt.plot(x1_values, y1_values, color='purple', linewidth=1, label="FRA")
plt.plot(x2_values, y2_values, color='pink', linewidth=1, label="JAP")
plt.plot(x3_values, y3_values, color='gray', linewidth=1, label="NEW")
plt.plot(x5_values, y5_values, color='orange', linewidth=1, label="SOU")
plt.plot(x6_values, y6_values, color='blue', linewidth=1, label="SWE")
plt.plot(x7_values, y7_values, color='yellow', linewidth=1, label="UKR")
...
#plt.show()
plt.savefig("../plots/lab5/avgTemAll.png")